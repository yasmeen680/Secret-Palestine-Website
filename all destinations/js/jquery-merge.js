...
* http://jqueryui.com
* Includes: widget.js, position.js, data.js, jquery-patch.js, keycode.js, scroll-parent.js, unique-id.js, widgets/draggable.js, widgets/droppable.js, widgets/autocomplete.js, widgets/menu.js, widgets/mouse.js, widgets/slider.js
...
!function (t) {
    ...
    C = Math.max, P = Math.abs, o = /left|center|right/, l = /top|center|bottom/, h = /[\+\-]\d+(\.[\d]+)?%?/, u = /^\w+/, c = /%$/, k = x.fn.position, x.position = {
        scrollbarWidth: function () {
            ...
            var e = x(t || window), i = T(e[0]), s = !!e[0] && 9 === e[0].nodeType;
            return {
                element: e,
                isWindow: i,
                isDocument: s,
        ...
        var p, d, f, m, g, t, v = "string" == typeof (c = x.extend({}, c)).of ? x(document).find(c.of) : x(c.of), _ = x.position.getWithinInfo(c.within),
            b = x.position.getScrollInfo(_), y = (c.collision || "flip").split(" "), w = {},
            e = 9 === (t = (e = v)[0]).nodeType ? {width: e.width(), height: e.height(), offset: {top: 0, left: 0}} : T(t) ? {
                width: e.width(),
                height: e.height(),
        ...
        return v[0].preventDefault && (c.at = "left top"), d = e.width, f = e.height, g = x.extend({}, m = e.offset), x.each(["my", "at"], function () {
            ...
            (i = 1 === i.length ? o.test(i[0]) ? i.concat(["center"]) : l.test(i[0]) ? ["center"].concat(i) : ["center", "center"] : i)[0] = o.test(i[0]) ? i[0] : "center", i[1] = l.test(i[1]) ? i[1] : "center", t = h.exec(i[0]), e = h.exec(i[1]), w[this] = [t ? t[0] : 0, e ? e[0] : 0], c[this] = [u.exec(i[0])[0], u.exec(i[1])[0]]
        }), 1 === y.length && (y[1] = y[0]), "right" === c.at[0] ? g.left += d : "center" === c.at[0] && (g.left += d / 2), "bottom" === c.at[1] ? g.top += f : "center" === c.at[1] && (g.top += f / 2), p = M(w.at, d, f), g.left += p[0], g.top += p[1], this.each(function () {
            var i, t, a = x(this), r = a.outerWidth(), l = a.outerHeight(), e = E(this, "marginLeft"), s = E(this, "marginTop"),
                n = r + e + E(this, "marginRight") + b.width, o = l + s + E(this, "marginBottom") + b.height, h = x.extend({}, g),
                u = M(w.my, a.outerWidth(), a.outerHeight());
            "right" === c.my[0] ? h.left -= r : "center" === c.my[0] && (h.left -= r / 2), "bottom" === c.my[1] ? h.top -= l : "center" === c.my[1] && (h.top -= l / 2), h.left += u[0], h.top += u[1], i = {
                ...
                var e = m.left - h.left, i = e + d - r, s = m.top - h.top, n = s + f - l, o = {
                    target: {element: v, left: m.left, top: m.top, width: d, height: f},
                    element: {element: a, left: h.left, top: h.top, width: r, height: l},
                    horizontal: i < 0 ? "left" : 0 < e ? "right" : "center",
                    vertical: n < 0 ? "top" : 0 < s ? "bottom" : "middle"
                };
                d < r && P(e + i) < d && (o.horizontal = "center"), f < l && P(s + n) < f && (o.vertical = "middle"), C(P(e), P(i)) > C(P(s), P(n)) ? o.important = "horizontal" : o.important = "vertical", c.using.call(this, t, o)
            }), a.offset(x.extend(h, {using: t}))
        })
    }, x.ui.position = {
        fit: {
            left: function (t, e) {
                var i = e.within, s = i.isWindow ? i.scrollLeft : i.offset.left, n = i.width, o = t.left - e.collisionPosition.marginLeft, a = s - o,
                ...
                var i = e.within, s = i.isWindow ? i.scrollTop : i.offset.top, n = e.within.height, o = t.top - e.collisionPosition.marginTop, a = s - o,
            ...
            left: function (t, e) {
                ...
                r < 0 ? ((s = t.left + h + i + a + e.collisionWidth - n - s) < 0 || s < P(r)) && (t.left += h + i + a) : 0 < l && (0 < (o = t.left - e.collisionPosition.marginLeft + h + i + a - o) || P(o) < l) && (t.left += h + i + a)
            }, top: function (t, e) {
                ...
                r < 0 ? ((s = t.top + h + i + a + e.collisionHeight - n - s) < 0 || s < P(r)) && (t.top += h + i + a) : 0 < l && (0 < (o = t.top - e.collisionPosition.marginTop + h + i + a - o) || P(o) < l) && (t.top += h + i + a)
            }
        }, flipfit: {
            left: function () {
    ...
    x.widget("ui.mouse", {
        version: "1.13.1", options: {cancel: "input, textarea, button, select, option", distance: 1, delay: 0}, _mouseInit: function () {
            var e = this;
    ...
    x.widget("ui.draggable", x.ui.mouse, {
        ...
        start: function (t, e, i) {
            ...
            for (var s, n, o, a, r, l, h, u, c, p = i.options, d = p.snapTolerance, f = e.offset.left, m = f + i.helperProportions.width, g = e.offset.top, v = g + i.helperProportions.height, _ = i.snapElements.length - 1; 0 <= _; _--) l = (r = i.snapElements[_].left - i.margins.left) + i.snapElements[_].width, u = (h = i.snapElements[_].top - i.margins.top) + i.snapElements[_].height, m < r - d || l + d < f || v < h - d || u + d < g || !x.contains(i.snapElements[_].item.ownerDocument, i.snapElements[_].item) ? (i.snapElements[_].snapping && i.options.snap.release && i.options.snap.release.call(i.element, t, x.extend(i._uiHash(), {snapItem: i.snapElements[_].item})), i.snapElements[_].snapping = !1) : ("inner" !== p.snapMode && (s = Math.abs(h - v) <= d, n = Math.abs(u - g) <= d, o = Math.abs(r - m) <= d, a = Math.abs(l - f) <= d, s && (e.position.top = i._convertPositionTo("relative", {
                ...
                top: 0,
                left: l
            }).left)), c = s || n || o || a, "outer" !== p.snapMode && (s = Math.abs(h - g) <= d, n = Math.abs(u - v) <= d, o = Math.abs(r - f) <= d, a = Math.abs(l - m) <= d, s && (e.position.top = i._convertPositionTo("relative", {
                top: h,
                left: 0
            }).top), n && (e.position.top = i._convertPositionTo("relative", {
            ...
            }).left)), !i.snapElements[_].snapping && (s || n || o || a || c) && i.options.snap.snap && i.options.snap.snap.call(i.element, t, x.extend(i._uiHash(), {snapItem: i.snapElements[_].item})), i.snapElements[_].snapping = s || n || o || a || c)
        }
    ...
    x.widget("ui.droppable", {
        ...
        _drop: function (e, t) {
            ...
            return !(!i || (i.currentItem || i.element)[0] === this.element[0]) && (this.element.find(":data(ui-droppable)").not(".ui-draggable-dragging").each(function () {
                ...
                if (t.options.greedy && !t.options.disabled && t.options.scope === i.options.scope && t.accept.call(t.element[0], i.currentItem || i.element) && x.ui.intersect(i, x.extend(t, {offset: t.element.offset()}), t.options.tolerance, e)) return !(s = !0)
        ...
        var n = (t.positionAbs || t.position.absolute).left + t.margins.left, o = (t.positionAbs || t.position.absolute).top + t.margins.top,
            a = n + t.helperProportions.width, r = o + t.helperProportions.height, l = e.offset.left, h = e.offset.top, u = l + e.proportions().width,
            c = h + e.proportions().height;
        switch (i) {
            case"fit":
                return l <= n && a <= u && h <= o && r <= c;
            case"intersect":
                return l < n + t.helperProportions.width / 2 && a - t.helperProportions.width / 2 < u && h < o + t.helperProportions.height / 2 && r - t.helperProportions.height / 2 < c;
            case"pointer":
                return f(s.pageY, h, e.proportions().height) && f(s.pageX, l, e.proportions().width);
            case"touch":
                return (h <= o && o <= c || h <= r && r <= c || o < h && c < r) && (l <= n && n <= u || l <= a && a <= u || n < l && u < a);
            default:
                return !1
        }
    }, !(x.ui.ddmanager = {
        current: null, droppables: {default: []}, prepareOffsets: function (t, e) {
            ...
            n.options.refreshPositions && x.ui.ddmanager.prepareOffsets(n, o), x.each(x.ui.ddmanager.droppables[n.options.scope] || [], function () {
                var t, e, i, s;
                this.options.disabled || this.greedyChild || !this.visible || (s = !(i = x.ui.intersect(n, this, this.options.tolerance, o)) && this.isover ? "isout" : i && !this.isover ? "isover" : null) && (this.options.greedy && (e = this.options.scope, (i = this.element.parents(":data(ui-droppable)").filter(function () {
    ...
    x.ui.droppable, x.widget("ui.menu", {
        version: "1.13.1",
        defaultElement: "<ul>",
        delay: 300,
        options: {
    ...
    x.ui.autocomplete, x.widget("ui.slider", x.ui.mouse, {
        version: "1.13.1",
...
!function (a, b, c, d) {
    ...
    e.Defaults = {video: !1, videoHeight: !1, videoWidth: !1}, e.prototype.fetch = function (a, b) {
        ...
        var d, e, f, g = c.width && c.height ? 'style="width:' + c.width + "px;height:" + c.height + 'px;"' : "", h = b.find("img"), i = "src", j = "",
...
var jvh = jvh || {}
jvh.wait = jvh.wait || [];
jvh.data.jsLoaded["jquery"] = true;
$(document).trigger("jquery-loaded");
jvhTriggerEvent('jquery-jsLoaded');